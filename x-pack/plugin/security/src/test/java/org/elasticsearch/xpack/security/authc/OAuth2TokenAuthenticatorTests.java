...
public class OAuth2TokenAuthenticatorTests extends AbstractAuthenticatorTests {
    ...
    public void testRecordingFailedAuthenticationMetrics() {
        ...
        // verify we recorded failure metric with fault attribute (401 -> CLIENT)
        assertSingleFailedAuthMetric(
            telemetryPlugin,
            SecurityMetricType.AUTHC_OAUTH2_TOKEN,
            Map.of(OAuth2TokenAuthenticator.ATTRIBUTE_TOKEN_AUTHC_FAILURE_REASON, AuthcFailureReason.CLIENT_AUTHENTICATION_FAILED.value())
        );
